...
namespace CamRover.ControllerApp
{
	...
	public static class MauiProgram
	{
		public static MauiApp CreateMauiApp()
		{
			...
			builder.Services.AddSingleton<Models.CommModel>();

			//builder.Services.AddSingleton<Services.NavigationService>();

			builder.Services.AddSingleton<ViewModels.ControlViewModel>();
			builder.Services.AddScoped<ViewModels.SettingsViewModel>();

			builder.Services.AddSingleton<ControlPage>();
			builder.Services.AddScoped<Pages.SettingsPage>();
